...
Current development version: **v1.8.2** (`package.json` version `1.8.2`).
...
- **Release versions** (`v1.8.2`, etc.) are semver versions used by `package.json`, tags, GitHub Releases, and build artifacts.
...
Build artifacts are generated under `release/`. For v1.8.2, expected artifact names are `CoFinder-1.8.2-arm64.dmg` and `CoFinder-1.8.2-arm64.zip`.
