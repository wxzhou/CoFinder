...
Current development version: **v1.8.5** (`package.json` version `1.8.5`).
...
- **Release versions** (`v1.8.5`, etc.) are semver versions used by `package.json`, tags, GitHub Releases, and build artifacts.
...
Build artifacts are generated under `release/`. For v1.8.5, expected artifact names are `CoFinder-1.8.5-arm64.dmg` and `CoFinder-1.8.5-arm64.zip`.
