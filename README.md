...
Current development version: **v1.9.5** (`package.json` version `1.9.5`). Latest published release: **v1.9.0**.

## Current Capabilities

- Dual-pane local / remote browsing with tabs, sorting, filtering, optional expandable list rows, breadcrumbs, history, recents, and favorites.
